...
for i in range(num_models):
    mdn_network = ToyNet(model_id + "_%d" % i, project_dir="/root/ebms_proposals/mdn_age").cuda()
    ebm_network = ToyNet(model_id + "_%d" % i, project_dir="/root/ebms_proposals/mdn_age").cuda()
